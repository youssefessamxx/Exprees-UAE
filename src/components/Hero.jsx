...
function Hero() {
  return (
    <div className="bg-[url('https://res.cloudinary.com/dqsruh1bz/image/upload/v1728657457/Hero_k4icag.png')]  h-[600px] w-full bg-cover bg-center text-white flex items-center px-16 ">
